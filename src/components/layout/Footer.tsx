    ...
    <footer className='relative w-full overflow-x-hidden bg-black'>
      <div className='bg-[#1a1a1a] px-5 py-10 pt-[70px] md:px-10 md:pt-[160px] md:pb-[50px]'>
        <div className='mx-auto max-w-[1440px]'>
          <nav className='mb-10 md:mb-25'>
            <ul className='flex flex-col items-center gap-5 text-center md:hidden'>
        ...
        <div className='mx-auto'>
          <div className='flex flex-col items-center gap-5 md:flex-row md:justify-between md:gap-0'>
            {socialLinks && socialLinks.length > 0 && (
              <ul className='order-1 flex md:order-none'>
                {socialLinks
                  ...
                  .map((social, index) => (
                    <li key={index}>
                      <Link
                        ...
                        className='group relative block h-5 w-5 transition-all'
            ...
            <ul className='order-2 flex flex-wrap justify-center gap-2.5 md:order-none md:flex-nowrap md:gap-8'>
      ...
      <section className='bg-black px-5 py-8 md:px-10' aria-label='Newsletter signup'>
        <div className='mx-auto'>
          <div className='flex flex-col gap-6 md:flex-row md:items-end md:justify-between md:gap-0'>
            <div className='md:max-w-[430px]'>
              <h2 className='mb-[2px] font-serif text-[24px] leading-[1.1] tracking-[-0.015em] text-white md:text-[28px]'>
                {newsletterTitle}
              </h2>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 md:flex-row md:items-end md:gap-6'>
              <div className='relative w-full md:w-[220px]'>
                ...
                />
                <IoChevronDown
                  className='absolute right-0 bottom-[13px] h-[14px] w-[14px] text-white'
                  aria-hidden='true'
                />
              </div>
